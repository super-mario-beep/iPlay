...
class AppUpdateDownloadSheet extends StatefulWidget {
  ...
  AppUpdateDownloadSheet(
      {@required this.newVersion, @required this.downloadUrl});
...
class _AppUpdateDownloadSheetState extends State<AppUpdateDownloadSheet> {
  ...
  Future<void> initDownload() async {
    ...
    if (permissionStatus == PermissionStatus.granted) {
      Dio dio = Dio();
      downloadFile = File((await ExtStorage.getExternalStoragePublicDirectory(
          ExtStorage.DIRECTORY_DOWNLOADS)) +
          "/update.apk");
      dio.download(widget.downloadUrl, downloadFile.path,
          ...
          child: Column(
            children: [
              AppBar(
                ...
                title: Text(Languages.of(context).labelDownloading,
                    style: TextStyle(
                        color: Theme.of(context).textTheme.bodyText1.color,
                        fontWeight: FontWeight.w600,
                        fontFamily: 'Product Sans')),
